...
public class TShirtControllerTest {
    ...
    public void shouldCreateTShirt() throws Exception{
        ...
        when(tShirtService.createTShirt(inTShirtViewModel)).thenReturn(savedTShirtViewModel);
    ...
    public void shouldReturnTShirtInfo() throws Exception{
        ...
        when(tShirtService.getTShirt(51)).thenReturn(savedTShirtViewModel);
    ...
    public void shouldUpdateTShirt() throws Exception{
        ...
        doNothing().when(tShirtService).updateTShirt(inTShirtViewModel);
    ...
    public void shouldDeleteTShirt() throws Exception{
        ...
        //Nothing to mock!
        //Checking checking for the correct response status code
        doNothing().when(tShirtService).deleteTShirt(51);
    ...
    public void shouldGetTShirtByColor() throws Exception{
        ...
        //Mock call to service layer...
        when(tShirtService.getTShirtByColor("SkyBlue")).thenReturn(foundList);
        ...
        //Mock call to service layer...
        when(tShirtService.getTShirtByColor("non-existent color")).thenReturn(null);
    ...
    public void shouldGetTShirtBySize() throws Exception{
        ...
        //Mock call to service layer...
        when(tShirtService.getTShirtBySize("S")).thenReturn(foundList);
        ...
        //Mock call to service layer...
        when(tShirtService.getTShirtBySize("XL")).thenReturn(null);
    ...
    public void shouldGetAllTShirt() throws Exception{
        ...
        //Mock call to service layer...
        when(tShirtService.getAllTShirts()).thenReturn(foundList);
        ...
        //Mock call to service layer...
        when(tShirtService.getAllTShirts()).thenReturn(null);
    ...
    public void shouldFailCreateTShirtWithBadData() throws Exception{
        ...
        //Mock call to service layer...
        when(tShirtService.createTShirt(inTShirtViewModel)).thenReturn(null);
