package com.service.gamestoreinvoicing.service;

import com.service.gamestoreinvoicing.feign.GameStoreCatalogClient;
import com.service.gamestoreinvoicing.model.*;
import com.service.gamestoreinvoicing.repository.InvoiceRepository;
import com.service.gamestoreinvoicing.repository.ProcessingFeeRepository;
import com.service.gamestoreinvoicing.repository.TaxRepository;
import com.service.gamestoreinvoicing.viewModel.InvoiceViewModel;
...
public class GameStoreInvoiceServiceLayer {
    ...
    public GameStoreInvoiceServiceLayer(GameStoreCatalogClient gameStoreCatalogClient, InvoiceRepository invoiceRepo, TaxRepository taxRepo, ProcessingFeeRepository processingFeeRepo) {
    ...
    public InvoiceViewModel createInvoice(InvoiceViewModel invoiceViewModel) {
        ...
        if (invoiceViewModel.getItemType().equals(CONSOLE_ITEM_TYPE)) {
            ...
            Optional<Console> returnVal = gameStoreCatalogClient.findConsoleById(invoiceViewModel.getItemId());
            ...
            Game tempGame = null;
            Optional<Game> returnVal = gameStoreCatalogClient.findGameById(invoiceViewModel.getItemId());
            ...
            Optional<TShirt> returnVal = gameStoreCatalogClient.findTShirtById(invoiceViewModel.getItemId());
